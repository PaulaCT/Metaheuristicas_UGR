...
const std::string PARAMETRO_GENETICO_GENERACIONAL_UN = "AGG-UN";
const std::string PARAMETRO_GENETICO_GENERACIONAL_SF = "AGG-SF";
const std::string PARAMETRO_GENETICO_ESTACIONARIO_UN = "AGE-UN";
const std::string PARAMETRO_GENETICO_ESTACIONARIO_SF = "AGE-SF";
const std::string PARAMETRO_MEMETICO_10 = "AM-10";
const std::string PARAMETRO_MEMETICO_01 = "AM-01";
const std::string PARAMETRO_MEMETICO_MEJOR = "AM-M";
const std::string PARAMETRO_MEMETICO_10_1 = "AM-10-1";
const std::string PARAMETRO_MEMETICO_01_1 = "AM-01-1";
const std::string PARAMETRO_MEMETICO_MEJOR_1 = "AM-M-1";
...
enum Modo{GREEDY,BUSQUEDA_LOCAL,GENETICO_GENERACIONAL_UN,GENETICO_GENERACIONAL_SF,GENETICO_ESTACIONARIO_UN,
	 GENETICO_ESTACIONARIO_SF,MEMETICO_10,MEMETICO_01,MEMETICO_MEJOR,MEMETICO_10_1,MEMETICO_01_1,MEMETICO_MEJOR_1};
...
//Calcula la desviacion general de la particion c (almacenando las distancias en un vector)
double evaluarDistancias(std::vector<double> &distancias, std::vector<Cluster> c, std::vector<Node> x);
...
double distanciaElem(std::vector<Node> x, std::vector<double> centroide, std::vector<double> elemento);
